...
_grouping - обработка случаев, когда предикторпринимает только одно значение и есть пропуски
_grouping - обработка случаев, когда предикторпринимает только одно значение и НЕТ пропусков (сейчас должно падать)
